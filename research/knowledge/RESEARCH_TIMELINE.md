...
- **Record:** Completed V31 G1 economic plausibility screen for CAND-092 and CAND-093. Data: USATECHIDXUSD M1, 906,815 bars (2023-09-01 to 2026-07-10, 2.9 years). CAND-092 (Event-Information Decay): Treatment (high info, recent) N=3,195, Net Mean=-3.42 bps, Median=-2.51 bps, WR=46.3%. Control (low info, old) N=3,324, Net Mean=-1.31 bps, Median=-2.71 bps, WR=42.9%. Mean delta=-2.11 bps (control superior), Median delta=+0.21 bps (trivially positive), WR delta=+3.3%. Contradictory evidence across metrics. Wider dispersion in treatment (46.26 vs 27.47 bps std). CLOSED — MIXED EVIDENCE. CAND-093 (Price-Discovery Friction): Treatment (low friction) N=5,601, Net Mean=-2.67 bps, Median=-2.61 bps, WR=44.5%. Control (high friction) N=2,820, Net Mean=-1.66 bps, Median=-3.39 bps, WR=43.9%. Mean delta=-1.00 bps (control superior), Median delta=+0.77 bps (treatment better), WR delta=+0.6%. Contradictory evidence. CLOSED — MIXED EVIDENCE. Both candidates pass all 9 hard validity gates. Failures are in economic evidence. State potential: NOT JUSTIFIED for either. No G2. No confirmation. Forward runtime untouched. **Status:** V31 G1 COMPLETE — BOTH CANDIDATES CLOSED. V31 COMPLETE: 0 G2 promotions. NEXT: V32 G0 (if owner authorizes).
